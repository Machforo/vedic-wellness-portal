        ...
        <div className="container-wide max-w-5xl">
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="reveal delay-100 p-8 rounded-2xl border bg-navy text-white">
              ...
              <div 
                className="text-white/70 leading-relaxed rich-text" 
                dangerouslySetInnerHTML={{ __html: rt(missionVision?.mission || "To provide NCISM-standard BAMS education that combines mastery of classical Ayurvedic texts with modern clinical training — preparing graduates to practise, research, teach, and lead in all domains of Ayurvedic healthcare in India and globally.") }} 
              />
            </div>
          </div>
