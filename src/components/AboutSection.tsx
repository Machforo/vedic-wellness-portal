      ...
      <div className="container-wide">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="reveal-left relative">
            <div className="rounded-2xl overflow-hidden shadow-[0_8px_40px_hsl(var(--navy)/0.1)] bg-muted border">
              <img
                ...
                alt="Ishan Ayurvedic Medical College Campus"
          ...
          <div className="reveal-right space-y-6">
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-gold">About IAMC</p>
            <h2 className="font-bold text-foreground leading-tight">
              NCR's Only Private AYUSH College Rooted in Classical Ayurvedic Tradition
            </h2>
            <p className="text-foreground/70 leading-relaxed">
              Ishan Ayurvedic Medical College and Research Centre (IAMC), Greater Noida, is the only private AYUSH medical college in the National Capital Region. NCISM-approved and affiliated to its university, IAMC offers the five-and-a-half-year BAMS degree programme — spanning 14 academic departments, an in-campus Ayurvedic teaching hospital, a herbal garden of over 200 medicinal plant species, and a faculty of experienced Vaidyas committed to both classical scholarship and modern clinical practice.
            </p>
            ...
            <a href="/about" className="inline-flex items-center gap-2 mt-2 text-sm font-semibold text-navy hover:text-navy/80 transition-colors group">
              Learn More About IAMC
